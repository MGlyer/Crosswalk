      ...
      <div>
        <div>
          ...
          <div id='rowTwo'>
              ...
              <img src="img/hospitality.png" className="tag hospitality" id="Hospitality, Tourism, and Recreation" onMouseEnter={this.handleHover} onMouseLeave={this.handleHover} onClick={this.props.handleQuickPathwaySearch}/>
          </div>
          <div id='rowThree'>
